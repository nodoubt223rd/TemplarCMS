---
layout: Conceptual
title: .NET Coding Conventions - C# | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/dotnet/csharp/fundamentals/coding-style/coding-conventions
apiPlatform: dotnet
author: BillWagner
...
show_latex: true
uhfHeaderId: MSDocsHeader-DotNetCSharp
...
locale: en-us
document_id: 40f42506-f4a5-859a-0266-ded002056d83
document_version_independent_id: f940f2ad-e13d-4d37-6439-f8afcbc4e4c7
updated_at: 2026-03-30T21:10:00.0000000Z
original_content_git_url: https://github.com/dotnet/docs/blob/live/docs/csharp/fundamentals/coding-style/coding-conventions.md
gitcommit: https://github.com/dotnet/docs/blob/156931bb4ec1e81b028c76ea983553f2e9778bdd/docs/csharp/fundamentals/coding-style/coding-conventions.md
...
word_count: 3135
asset_id: csharp/fundamentals/coding-style/coding-conventions
moniker_range_name: 
monikers: []
item_type: Content
...
platformId: 1381f1af-2bf9-1c4d-d7f1-30d5908c6e57
---
...
- Use the default Code Editor settings (smart indenting, four-character indents, tabs saved as spaces). For more information, see [Options, Text Editor, C#, Formatting](/en-us/visualstudio/ide/reference/options-text-editor-csharp-formatting).
...
Follow the guidelines in [Secure Coding Guidelines](../../../standard/security/secure-coding-guidelines).